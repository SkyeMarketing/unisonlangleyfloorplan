...
const  ThankYou: React.FC = (): JSX.Element => {
  return (
    <>
      <main className={`w-screen h-screen bg-img bg-cover bg-no-repeat bg-blend-darken`}>
        <div className={`backdrop-blur-md w-full h-full bg-aqua/10 bg-blend-hard-light pt-16`}>
