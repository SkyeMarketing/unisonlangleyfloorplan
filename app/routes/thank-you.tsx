...
const  ThankYou: React.FC = (): JSX.Element => {
  return (
      <main className={`flex flex-col items-center py-8 bg-center w-full mx-auto h-full bg-img bg-cover bg-fixed bg-no-repeat bg-blend-darken bg-blend-darken relative`}>
